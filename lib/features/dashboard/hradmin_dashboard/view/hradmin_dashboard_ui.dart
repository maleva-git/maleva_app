...
import '../../common_tabs/license/view/license_view.dart';
...
class HrAMobileDashboard extends StatelessWidget {
  final TabController tabController;
  final bool isTablet;
  const HrAMobileDashboard({required this.tabController, required this.isTablet, super.key});
...
// ✅ Step 1: _tab() method-ல isTablet add பண்ணு
  ...
  Widget _buildTabBarView(BuildContext context) {
    return BlocListener<HrAdminTabBloc, HrAdminTabState>(
