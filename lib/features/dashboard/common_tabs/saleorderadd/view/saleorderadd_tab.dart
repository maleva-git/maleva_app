...
Navigator.pushReplacement(
  ...
  AppBar _buildAppBar(
    ...
    final titleSize =
    isTablet ? AppGlobals.FontLarge + 2.0 : AppGlobals.FontMedium.toDouble();
    final subSize =
    isTablet ? AppGlobals.FontLow.toDouble() : (AppGlobals.FontLow - 2).toDouble();
              ...
              Navigator.push(
                ...
                if (AppGlobals.SelectCustomerList.Id != 0) {
                  bloc.add(SalesOrderCustomerSelected(
                    ...
                    custName: AppGlobals.SelectCustomerList.AccountName,
                  ));
              ...
              Navigator.push(
                ...
                if (AppGlobals.SelectJobTypeList.Id != 0) {
                  bloc.add(SalesOrderJobTypeSelected(
                    ...
                    jobTypeName: AppGlobals.SelectJobTypeList.Name,
                  ));
              ...
              Navigator.push(
                ...
                if (AppGlobals.SelectAllStatusList.Status != 0) {
                  bloc.add(SalesOrderJobStatusSelected(
                    ...
                    statusName: AppGlobals.SelectAllStatusList.StatusName,
                  ));
              ...
              onSearch: () => Navigator.push(
                ...
                if (AppGlobals.SelectLocationList.Id != 0) {
                  bloc.add(SalesOrderOriginSelected(
                    ...
                    name: AppGlobals.SelectLocationList.Location,
                  ));
                  txtOrigin.text = AppGlobals.SelectLocationList.Location;
            ...
            _searchField(
              ...
              onSearch: () => Navigator.push(
                ...
                if (AppGlobals.SelectLocationList.Id != 0) {
                  ...
                  txtDestination.text = AppGlobals.SelectLocationList.Location;
                  AppGlobals.SelectLocationList = LocationModel.Empty();
                }
              }),
              isTablet: isTablet,
              ...
              Navigator.push(
                ...
                if (AppGlobals.SelectAddressList.isNotEmpty) {
                  ...
                  bloc.add(SalesOrderPickupAddressListUpdated(
                    ...
                    displayText: AppGlobals.SelectAddressList,
                  ));
              ...
              onSearch: () => Navigator.push(
                ...
                if (AppGlobals.SelectAgentCompanyList.Id != 0) {
                  bloc.add(SalesOrderLAgentCompanySelected(
                      ...
                      name: AppGlobals.SelectAgentCompanyList.Name));
              ...
              onSearch: () => Navigator.push(
                ...
                if (AppGlobals.SelectAgentAllList.Id != 0) {
                  bloc.add(SalesOrderLAgentSelected(
                      ...
                      name: AppGlobals.SelectAgentAllList.AgentName));
