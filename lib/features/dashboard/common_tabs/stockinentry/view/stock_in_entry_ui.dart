...
class _StockInEntryPageState
  ...
  Future<void> _pickImage(
    ...
    if (statusName.isEmpty) {
      toastMsg('Select Status!!', '', context);
      return;
    }
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () async {
        ...
        // The BLoC has already fetched job statuses into AppGlobals.JobAllStatusList!
        Navigator.push(
          context,
          MaterialPageRoute(
          ...
          if (sel.Status != 0) {
            ...
            AppGlobals.SelectAllStatusList =
    ...
    return Container(
      ...
      child: state.images.isEmpty
        ...
        child: GridView.builder(
          ...
          itemBuilder: (ctx, i) {
            final url =
                '${AppGlobals.imagepath}SalesOrder/${state.saleOrderId}/$folder/${state.images[i]}';
            return InkWell(
              onLongPress: () async {
                final ok =
