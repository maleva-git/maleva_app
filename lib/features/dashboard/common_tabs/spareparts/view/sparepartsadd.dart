...
import 'package:maleva/features/dashboard/common_tabs/spareparts/view/sparepartsview.dart';
...
class _SparePartsEntryBody extends StatelessWidget {
  ...
  Widget _buildFormContent(
    ...
    final truckName = AppGlobals.GetTruckList
              ...
              children: [
                Container(
                  ...
                  child: const Icon(Icons.build_rounded,
                      color: AppTokens.brandGradientStart, size: 17),
                ),
                const SizedBox(width: 10),
                Expanded(
                  child: Column(
...
class _SparePartsTruckSelectPageState
  ...
  void initState() {
    super.initState();
    _filtered = List.from(AppGlobals.GetTruckList);
  }

  void _search(String q) {
    setState(() {
      _filtered = q.isEmpty
          ? List.from(AppGlobals.GetTruckList)
          : AppGlobals.GetTruckList
