...
class _JobStatusUpdateViewState extends State<_JobStatusUpdateView> {
  ...
  void _showOverlay(List<Map<String, dynamic>> suggestions) {
    ...
    final topOffset = AppGlobals.MalevaScreen == 1
    ...
    _overlayEntry = OverlayEntry(
      builder: (_) => Positioned(
        top: topOffset,
        left: AppGlobals.MalevaScreen == 1 ? 10 : 70,
        right: AppGlobals.MalevaScreen == 1 ? 10 : 500,
        child: Material(
  ...
  Future<bool> _confirm(String msg) =>
      ConfirmationMsgYesNo(context, msg);

  Future<void> _ok(String msg) => ConfirmationOK(msg, context);
  ...
  void _handleStateChange(
    ...
    if (state.status == JobStatusUpdateStatus.failure &&
      ...
      toastMsg(state.errorMessage, '', context);
    }
  }
        ...
        child: Column(
          ...
          children: [
            CachedNetworkImage(
              ...
              imageUrl:
              '${AppGlobals.imagepath}SalesOrder/${state.saleOrderId}/Boarding/${state.imageNetworkNames[index]}',
            ),
            const SizedBox(height: 7),
            CircleAvatar(
              backgroundColor: colour.commonColorLight,
    ...
    return Column(
      ...
      children: [
        ...
        GridView.builder(
          ...
          itemBuilder: (_, i) {
            final url =
                '${AppGlobals.imagepath}SalesOrder/${state.saleOrderId}/Boarding/${state.imageNetworkNames[i]}';
            return Stack(
              children: [
                // Image thumbnail
                GestureDetector(
