                      ...
                      child: SingleChildScrollView(
                        ...
                        child: DataTable(
                          ...
                          columns: const [
                            ...
                            DataColumn(label: Text('Fuel No', style: TextStyle(color: Colors.white))),
                            DataColumn(label: Text('Fuel Date', style: TextStyle(color: Colors.white))),
                            ...
                            DataColumn(label: Text('ALiter', style: TextStyle(color: Colors.white))),
                            DataColumn(label: Text('AAmount', style: TextStyle(color: Colors.white))),
                            DataColumn(label: Text('PLiter', style: TextStyle(color: Colors.white))),
                            DataColumn(label: Text('PAmount', style: TextStyle(color: Colors.white))),
                            DataColumn(label: Text('GLiter', style: TextStyle(color: Colors.white))),
                            DataColumn(label: Text('GAmount', style: TextStyle(color: Colors.white))),
                            DataColumn(label: Text('Diff Liter', style: TextStyle(color: Colors.white))),
                            DataColumn(label: Text('Diff Amount', style: TextStyle(color: Colors.white))),
                          ...
                          rows: entries.map((e) {
                            return DataRow(cells: [
                              ...
                              DataCell(Text(e.pRate.toStringAsFixed(2))),
                              DataCell(Text(e.aLiter.toStringAsFixed(2))),
                              DataCell(Text(e.aAmount.toStringAsFixed(2))),
                              DataCell(Text(e.pLiter.toStringAsFixed(2))),
                              DataCell(Text(e.pAmount.toStringAsFixed(2))),
                              DataCell(Text(e.gLiter.toStringAsFixed(2))),
                              DataCell(Text(e.gAmount.toStringAsFixed(2))),
                              DataCell(Text(e.dgLiter.toStringAsFixed(2), style: TextStyle(color: e.dgLiter < 0 ? Colors.red : Colors.green))),
                              DataCell(Text(e.dgAmount.toStringAsFixed(2), style: TextStyle(color: e.dgAmount < 0 ? Colors.red : Colors.green))),
