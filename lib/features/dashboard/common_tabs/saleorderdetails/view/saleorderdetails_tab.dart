...
class _SaleOrderDetailsViewState extends State<_SaleOrderDetailsView>
  ...
  double get _fontLow    => AppGlobals.FontLow;
  double get _fontMedium => AppGlobals.FontMedium;
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    height: 35,
                    decoration: BoxDecoration(
                      image: DecorationImage(image: AppGlobals.calendar),
                    ),
                  ),
                ),
              ],
