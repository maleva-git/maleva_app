...
class RTIViewRepository {
  ...
  Future<dynamic> fetchRTIRecords({
    ...
    final url = "${objfun.apiSelectRTIView}$comId&Fromdate=$fromDate&Todate=$toDate&DId=0&TId=0&Employeeid=0&Search=";
  ...
  Future<String?> fetchRTIPdfUrl({
    ...
    final result = await ApiClient.postRequest("${objfun.apiViewRTIPdf}$rtiNo", body);
