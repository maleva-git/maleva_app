...
class _RTIStatusView extends StatelessWidget {
  ...
  AppBar _buildAppBar(
    ...
    final titleFontSize =
    isTablet ? objfun.FontLarge.toDouble() : objfun.FontMedium.toDouble();
    final subFontSize = isTablet
        ? objfun.FontLow.toDouble()
        : (objfun.FontLow - 2).toDouble();
            ...
            child: state.imageNetwork.isEmpty
              ...
              child: Text(
                ...
                style: GoogleFonts.lato(
                  color: colour.commonColorLight,
                  fontWeight: FontWeight.bold,
                  fontSize: objfun.FontLow.toDouble(),
                ),
              ),
            )
                : GridView.builder(
              ...
              itemBuilder: (context, index) {
                final imageUrl =
                    '${objfun.imagepath}SalesOrder/${state.saleOrderId}/${state.driverFolder}/${state.imageNetwork[index]}';
