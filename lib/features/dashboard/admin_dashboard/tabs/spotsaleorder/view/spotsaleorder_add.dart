    ...
    return BlocConsumer<SpotSaleBloc, SpotSaleState>(
      listener: (context, state) {
        if (state is SpotSaleSubmitSuccess) {
          ...
          context.read<SpotSaleBloc>().add(const ResetSpotSaleFormEvent());
        }
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // ════════════════════════════════════════════════
                // SECTION 1 — Job Info (3 selectors)
                // ════════════════════════════════════════════════
                _SectionCard(
                  ...
                  children: [
                    ...
                    _SelectTile(
                      ...
                      onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => _JobTypeSelectPage(bloc: bloc),
                        ),
                      ),
                    ),
                    ...
                    _SelectTile(
                      ...
                      label: "Status",
                      value: jobStatusName.isNotEmpty ? jobStatusName : null,
                      placeholder: "Tap to select Status",
                      onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => _JobStatusSelectPage(bloc: bloc),
                        ),
                      ),
                    ),
                    ...
                    _SelectTile(
                      ...
                      onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => _PortSelectPage(bloc: bloc),
                        ),
                      ),
                    ),
                  ],
                ...
                _SectionCard(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      onChanged: (v) => bloc.add(UpdateCargoQtyEvent(v)),
                      validator: (v) => (v == null || v.trim().isEmpty)
                          ? "Please enter Cargo Qty"
                          : null,
                      decoration: _decor("Cargo Qty", Icons.numbers_rounded),
                    ),
                    ...
                    TextFormField(
                      ...
                      onChanged: (v) => bloc.add(UpdateVehicleNameEvent(v)),
                      validator: (v) => (v == null || v.trim().isEmpty)
                          ? "Please enter Vehicle Name"
                          : null,
                      decoration: _decor(
                          "Vehicle Name", Icons.local_shipping_rounded),
                    ),
                    ...
                    TextFormField(
                      ...
                      validator: (v) => (v == null || v.trim().isEmpty)
                          ...
                          : null,
                      decoration: _decor(
                          "Air Waybill Number", Icons.confirmation_number_rounded),
                    ),
                    ...
                    TextFormField(
                      ...
                      keyboardType: TextInputType.number,
                      onChanged: (v) => bloc.add(UpdateCargoWeightEvent(v)),
                      validator: (v) => (v == null || v.trim().isEmpty)
                          ? "Please enter Cargo Weight"
                          : null,
                      decoration:
                      _decor("Cargo Weight (kg)", Icons.scale_rounded),
                    ),
                  ],
                ),
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: s.isSubmitting
                        ...
                        if (_formKey.currentState!.validate()) {
                          bloc.add(const SubmitSpotSaleEvent());
                        }
                      },
                  ...
                  Expanded(
                    child: ElevatedButton(
                      ...
                      onPressed: () => Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (_) => const SpotSaleViewPage())),
                      child: Text("View",
                          style: GoogleFonts.lato(
                              fontSize: 18,
                              fontWeight: FontWeight.bold,
...
class _JobTypeSelectPage extends StatefulWidget {
  ...
  @override
  State<_JobTypeSelectPage> createState() => _JobTypeSelectPageState();
}
  ...
  void _search(String q) {
    setState(() {
      _filtered = q.isEmpty
          ...
          : objfun.JobTypeList
          .where((j) =>
          (j.Name ?? '').toUpperCase().contains(q.toUpperCase()))
          .toList();
    });
  }
    ...
    return _SelectPageScaffold(
      ...
      listBuilder: (i) {
        ...
        return _SelectListTile(
          label: item.Name ?? '',
          onTap: () {
            widget.bloc.add(SelectJobTypeEvent(item.Id.toString()));
...
class _JobStatusSelectPage extends StatefulWidget {
  ...
  @override
  State<_JobStatusSelectPage> createState() => _JobStatusSelectPageState();
}

class _JobStatusSelectPageState extends State<_JobStatusSelectPage> {
  final _searchCtrl = TextEditingController();
    ...
    return _SelectPageScaffold(
      ...
      listBuilder: (i) {
        ...
        return _SelectListTile(
          label: item.Name ?? '',
          onTap: () {
            widget.bloc.add(SelectJobStatusEvent(item.Id.toString()));
            Navigator.pop(context);
          },
        );
      },
...
// ─────────────────────────────────────────────────────────────────────────────
// SELECT PAGE — Port (static list from objfun.Portlist)
// ─────────────────────────────────────────────────────────────────────────────
  ...
  void _search(String q) {
    setState(() {
      _filtered = q.isEmpty
          ...
          : objfun.Portlist
          .where((p) =>
          (p.name ?? '').toUpperCase().contains(q.toUpperCase()))
          .toList();
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(children: [
        // Search bar — blue header continuation
        Container(
        ...
        Padding(
          ...
          child: Row(children: [
            Icon(icon, color: colour.kPrimaryLight, size: 16),
...
class _SelectListTile extends StatelessWidget {
  ...
  const _SelectListTile({required this.label, required this.onTap});
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(children: [
          ...
          const Icon(Icons.chevron_right_rounded, color: colour.kPrimaryLight),
        ]),
      ),
    );
  }
...
// ─────────────────────────────────────────────────────────────────────────────
// SELECT TILE (shows chosen value)
// ─────────────────────────────────────────────────────────────────────────────
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(children: [
          Icon(icon,
              color: hasValue ? colour.kPrimary : Colors.grey, size: 20),
          const SizedBox(width: 12),
          Expanded(
            child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  ...
                  Text(
                    ...
                    style: GoogleFonts.lato(
                        fontSize: 14,
                        color:
                        hasValue ? colour.kPrimaryDark : Colors.grey.shade400,
                        fontWeight:
