...
class SpotSaleRepository {
  ...
  Future<dynamic> fetchJobTypes(int comId) async {
    return await ApiClient.postRequest("${objfun.apiSelectJobType}$comId", null);
  }

  /// Fetches Job Statuses
  Future<dynamic> fetchJobStatus(int comId) async {
    return await ApiClient.postRequest("${objfun.apiSelectJobStatus}$comId", null);
  }
  ...
  Future<dynamic> fetchSpotSaleRecords({
    ...
    final url = "${objfun.apiGetSpotSaleEntry}$comId&Fromdate=$fromDate&Todate=$toDate&Id=0";
