...
class _TransportSalesTabView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<TransportSalesBloc, TransportSalesState>(
      builder: (context, state) {
        ...
        return Scaffold(
          backgroundColor: const Color(0xFFF5F5F0), // Modern light background
          body: SafeArea(
            child: Stack(
              children: [
                ListView(
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: AppTokens.invoiceHeaderStart, // Matches your invoice tab
                    ...
                    Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton<String>(
                          ...
                          e['Id'].toString() == state.selectedEmpId)
                              ? state.selectedEmpId
                              : null,
                    ...
                    GridView.count(
                      ...
                      children: [
                        _StatCard(
                          ...
                          badge: 'This month',
                          accentColor: const Color(0xFF1555F3), // Blue
                        ...
                        _StatCard(
                          ...
                          badge: 'Pending',
                          accentColor: const Color(0xFFD85A30), // Coral/Red
                        ...
                        _StatCard(
                          ...
                          badge: 'Completed',
                          accentColor: const Color(0xFF1D9E75), // Teal/Green
                        ...
                        _StatCard(
                          ...
                          accentColor: const Color(0xFFBA7517), // Amber/Orange
                        ...
                        child: ClipRRect(
                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              // Progress bar logic (assuming max 100 days for visual scaling)
