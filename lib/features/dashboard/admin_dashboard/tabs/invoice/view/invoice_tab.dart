// lib/features/dashboard/admin_dashboard/tabs/invoice/view/invoice_tab.dart
//
// ── What changed ───────────────────────────────────────────────────
//  BEFORE                                AFTER
...
class _TabletBody extends StatelessWidget {
  ...
  const _TabletBody({required this.state, required this.data});
...
class _MobileBody extends StatelessWidget {
  final InvoiceLoaded state;
  final Map<String, dynamic> data;
  const _MobileBody({required this.state, required this.data});
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (ctx, index) =>
                  _BillingCard(item: billingData[index]),
            ),
          ),
        ],
      ),
...
void _showEmployeeDialog(BuildContext context, List<dynamic> data) {
  showDialog(
    context: context,
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (_, i) => _EmployeeCard(emp: data[i]),
              ),
            ),
...
class _BillingCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: InkWell(
        borderRadius: BorderRadius.circular(16),
        onTap: () => _showBillingDetail(context, item),
        child: Padding(
  ...
  void _showBillingDetail(BuildContext context, dynamic item) {
    showDialog(
      context: context,
      builder: (ctx) => Dialog(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: const [
          BoxShadow(
              color: Palette.grey200, blurRadius: 6, offset: Offset(0, 3))
        ],
      ),
...
class _MonthBarItem extends StatelessWidget {
  final String month, count, amount;
  final double current, prev, maxAmount;
  final bool isTablet;
  final VoidCallback onTap;
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: const [
          BoxShadow(
              color: Palette.grey200, blurRadius: 10, offset: Offset(0, 4))
        ],
      ),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
  ...
  LineChartData _buildChart(double today, double yesterday) {
    return LineChartData(
      gridData: FlGridData(
        ...
        const FlLine(color: Color(0x20808080), strokeWidth: 1),
      ),
