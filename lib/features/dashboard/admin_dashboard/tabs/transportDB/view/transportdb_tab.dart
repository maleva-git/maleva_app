...
class _TransportDashboardViewState extends State<_TransportDashboardView>
  ...
  void _onTabChanged() {
    ...
    if (idx == 0) bloc.add(LoadSalesDataRequested(empId: objfun.EmpRefId));
  ...
  Future<bool> _onWillPop() async {
    final result =
    await objfun.ConfirmationMsgYesNo(context, 'Are you Sure you want to Exit?');
    if (result) {
  ...
  AppBar _buildAppBar(BuildContext context, bool isTablet) {
    final titleSize = isTablet ? 28.0 : objfun.FontLarge.toDouble();
  ...
  Widget _centeredText(String text, bool isTablet) => Container(
    ...
    child: Text(
      ...
      style: GoogleFonts.lato(
        color: colour.commonColor,
        fontWeight: FontWeight.bold,
        fontSize: isTablet ? objfun.FontCardText + 2 : objfun.FontCardText,
      ),
    ),
  );
}
              ...
              Center(
                child: Text(
                  ...
                  style: GoogleFonts.lato(
                    ...
                    fontWeight: FontWeight.bold,
                    fontSize: isTablet ? objfun.FontLarge + 4 : objfun.FontLarge,
                  ),
                ),
              ),
              const SizedBox(height: 8),
