...
class AgentCompany extends StatefulWidget {
  ...
  const AgentCompany({super.key, required this.Searchby, required this.SearchId});

  @override
  _AgentCompanystate createState() {
    return _AgentCompanystate();
  }
}

class _AgentCompanystate extends State<AgentCompany> {
  bool progress = false;
  final txtSearch = TextEditingController();
  List<AgentCompanyModel> filtersearchlist = [];
  ...
  Future startup() async {
    await sl<LegacyApiRepository>().SelectAgentCompany(context);
    filtersearchlist.clear();
    filtersearchlist.addAll(AppGlobals.AgentCompanyList);
    setState(() {
      progress = true;
    });
  }
  ...
  void search(value) {
    ...
    if (vv == "") {
      filtersearchlist.clear();
      filtersearchlist.addAll(AppGlobals.AgentCompanyList.toList());
    } else {
      filtersearchlist.clear();
      filtersearchlist.addAll(AppGlobals.AgentCompanyList.where((element) =>
