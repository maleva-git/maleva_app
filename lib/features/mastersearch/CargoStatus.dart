...
class CargoStatus extends StatefulWidget {
  ...
  @override
  _CargoStatusstate createState() {
    return _CargoStatusstate();
  }
}
...
class _CargoStatusstate extends State<CargoStatus> {
  ...
  List<String> CargoStatusList = <String>[
    "AT AIRPORT",
    "NOT ARRIVED",
    "WESTPORT",
    "NORTHPORT",
  ...
  Widget build(BuildContext context) {
    ...
    return objfun.MalevaScreen == 1
      ...
      body: progress == true
          ? Container(
          padding: const EdgeInsets.only(left: 50,right: 50,top: 50,bottom: 40),
          child: Card(
            elevation: 12,
            child:ListView(
              children: [
