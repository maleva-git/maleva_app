...
class Driver extends StatefulWidget {
  ...
  const Driver({super.key, required this.Searchby, required this.SearchId});
...
class _Driverstate extends State<Driver> {
  ...
  List<GetTruckModel> filtersearchlist = [];
  ...
  Future startup() async {
    await sl<LegacyApiRepository>().SelectDriverList(context,null);
