...
class SalesOrderAddLoaded extends SalesOrderAddState {
  ...
  SalesOrderAddLoaded({
    ...
    this.checkBoxValueOETD = false, this.checkBoxValueLETA = false, this.checkBoxValueFlightTime = false, this.checkBoxValueLETB = false,
    this.checkBoxValueLETD = false, this.checkBoxValuePickUp = false, this.checkBoxValueDelivery = false, this.checkBoxValueWHEntry = false,
    this.checkBoxValueWHExit = false, this.checkBoxValueFW1 = false, this.checkBoxValueFW2 = false, this.checkBoxValueFW3 = false,
    this.visibleOffVessel = true, this.visibleLoadingVessel = true, this.visibleLETA = true, this.visibleFlightTime = true,
    this.visibleLETB = true, this.visibleLETD = true, this.visibleAWBNo = true, this.visibleBLCopy = true, this.visibleFORWARDING = true,
    this.visibleOrigin = true, this.visibleDestination = true, this.visibleZB = true, this.visibleOETA = true, this.visibleOETB = true,
    this.visibleOETD = true, this.visibleOShippingAgent = true, this.visibleOAgentName = true, this.visibleOScn = true, this.visibleLScn = true,
    this.visibleLShippingAgent = true, this.visibleLAgentName = true, this.visibleLVesselType = true, this.visibleOVesselType = true,
    this.visibleOPort = true, this.visibleLPort = true, this.visibleProductview = false, this.visibleFW1 = false, this.visibleFW2 = false,
    ...
    this.txtBoardingOfficer1 = '', this.txtBoardingOfficer2 = '', this.txtAmount1 = '', this.txtAmount2 = '', this.txtPortChargeRef1 = '',
    this.txtPortCharges = '', this.txtForwarding1S1 = '', this.txtForwarding1S2 = '', this.txtForwarding2S1 = '', this.txtForwarding2S2 = '',
    this.txtForwarding3S1 = '', this.txtForwarding3S2 = '', this.txtProductCode = '', this.txtProductDescription = '', this.txtProductQty = '',
  ...
  SalesOrderAddLoaded copyWith({
    ...
    bool? checkBoxValueOETA, bool? checkBoxValueOETB, bool? checkBoxValueOETD, bool? checkBoxValueLETA,
    bool? checkBoxValueFlightTime, bool? checkBoxValueLETB, bool? checkBoxValueLETD, bool? checkBoxValuePickUp,
    bool? checkBoxValueDelivery, bool? checkBoxValueWHEntry, bool? checkBoxValueWHExit, bool? checkBoxValueFW1,
    bool? checkBoxValueFW2, bool? checkBoxValueFW3, bool? visibleOffVessel, bool? visibleLoadingVessel,
    bool? visibleLETA, bool? visibleFlightTime, bool? visibleLETB, bool? visibleLETD, bool? visibleAWBNo,
    bool? visibleBLCopy, bool? visibleFORWARDING, bool? visibleOrigin, bool? visibleDestination, bool? visibleZB,
    bool? visibleOETA, bool? visibleOETB, bool? visibleOETD, bool? visibleOShippingAgent, bool? visibleOAgentName,
    bool? visibleOScn, bool? visibleLScn, bool? visibleLShippingAgent, bool? visibleLAgentName, bool? visibleLVesselType,
    bool? visibleOVesselType, bool? visibleOPort, bool? visibleLPort, bool? visibleProductview, bool? visibleFW1,
    ...
    String? txtZBRef1, String? txtZBRef2, String? txtBoardingOfficer1, String? txtBoardingOfficer2, String? txtAmount1,
    String? txtAmount2, String? txtPortChargeRef1, String? txtPortCharges, String? txtForwarding1S1, String? txtForwarding1S2,
    String? txtForwarding2S1, String? txtForwarding2S2, String? txtForwarding3S1, String? txtForwarding3S2,
    String? txtProductCode, String? txtProductDescription, String? txtProductQty, String? txtProductSaleRate,
    ...
    return SalesOrderAddLoaded(
      ...
      lAgentCompanyId: lAgentCompanyId ?? this.lAgentCompanyId, lAgentId: lAgentId ?? this.lAgentId, oAgentCompanyId: oAgentCompanyId ?? this.oAgentCompanyId,
      oAgentId: oAgentId ?? this.oAgentId, sealEmpId1: sealEmpId1 ?? this.sealEmpId1, sealEmpId2: sealEmpId2 ?? this.sealEmpId2,
      ...
      dtpDeliverydate: dtpDeliverydate ?? this.dtpDeliverydate, dtpWHEntrydate: dtpWHEntrydate ?? this.dtpWHEntrydate,
      dtpWHExitdate: dtpWHExitdate ?? this.dtpWHExitdate, dtpFW1date: dtpFW1date ?? this.dtpFW1date, dtpFW2date: dtpFW2date ?? this.dtpFW2date,
      dtpFW3date: dtpFW3date ?? this.dtpFW3date, checkBoxValueOETA: checkBoxValueOETA ?? this.checkBoxValueOETA,
      checkBoxValueOETB: checkBoxValueOETB ?? this.checkBoxValueOETB, checkBoxValueOETD: checkBoxValueOETD ?? this.checkBoxValueOETD,
      checkBoxValueLETA: checkBoxValueLETA ?? this.checkBoxValueLETA, checkBoxValueFlightTime: checkBoxValueFlightTime ?? this.checkBoxValueFlightTime,
      checkBoxValueLETB: checkBoxValueLETB ?? this.checkBoxValueLETB, checkBoxValueLETD: checkBoxValueLETD ?? this.checkBoxValueLETD,
      checkBoxValuePickUp: checkBoxValuePickUp ?? this.checkBoxValuePickUp, checkBoxValueDelivery: checkBoxValueDelivery ?? this.checkBoxValueDelivery,
      checkBoxValueWHEntry: checkBoxValueWHEntry ?? this.checkBoxValueWHEntry, checkBoxValueWHExit: checkBoxValueWHExit ?? this.checkBoxValueWHExit,
      checkBoxValueFW1: checkBoxValueFW1 ?? this.checkBoxValueFW1, checkBoxValueFW2: checkBoxValueFW2 ?? this.checkBoxValueFW2,
      checkBoxValueFW3: checkBoxValueFW3 ?? this.checkBoxValueFW3, visibleOffVessel: visibleOffVessel ?? this.visibleOffVessel,
      visibleLoadingVessel: visibleLoadingVessel ?? this.visibleLoadingVessel, visibleLETA: visibleLETA ?? this.visibleLETA,
      visibleFlightTime: visibleFlightTime ?? this.visibleFlightTime, visibleLETB: visibleLETB ?? this.visibleLETB,
      visibleLETD: visibleLETD ?? this.visibleLETD, visibleAWBNo: visibleAWBNo ?? this.visibleAWBNo, visibleBLCopy: visibleBLCopy ?? this.visibleBLCopy,
      visibleFORWARDING: visibleFORWARDING ?? this.visibleFORWARDING, visibleOrigin: visibleOrigin ?? this.visibleOrigin,
      visibleDestination: visibleDestination ?? this.visibleDestination, visibleZB: visibleZB ?? this.visibleZB,
      visibleOETA: visibleOETA ?? this.visibleOETA, visibleOETB: visibleOETB ?? this.visibleOETB, visibleOETD: visibleOETD ?? this.visibleOETD,
      visibleOShippingAgent: visibleOShippingAgent ?? this.visibleOShippingAgent, visibleOAgentName: visibleOAgentName ?? this.visibleOAgentName,
      visibleOScn: visibleOScn ?? this.visibleOScn, visibleLScn: visibleLScn ?? this.visibleLScn, visibleLShippingAgent: visibleLShippingAgent ?? this.visibleLShippingAgent,
      visibleLAgentName: visibleLAgentName ?? this.visibleLAgentName, visibleLVesselType: visibleLVesselType ?? this.visibleLVesselType,
      visibleOVesselType: visibleOVesselType ?? this.visibleOVesselType, visibleOPort: visibleOPort ?? this.visibleOPort,
      visibleLPort: visibleLPort ?? this.visibleLPort, visibleProductview: visibleProductview ?? this.visibleProductview,
      visibleFW1: visibleFW1 ?? this.visibleFW1, visibleFW2: visibleFW2 ?? this.visibleFW2, visibleFW3: visibleFW3 ?? this.visibleFW3,
      visibleGC: visibleGC ?? this.visibleGC, disabledBillType: disabledBillType ?? this.disabledBillType,
      disabledAmount1: disabledAmount1 ?? this.disabledAmount1, disabledAmount2: disabledAmount2 ?? this.disabledAmount2,
      dropdownValue: dropdownValue ?? this.dropdownValue,
      dropdownValueTruckSize: identical(dropdownValueTruckSize, _sentinel) ? this.dropdownValueTruckSize : dropdownValueTruckSize as String?,
      dropdownValueFW1: identical(dropdownValueFW1, _sentinel) ? this.dropdownValueFW1 : dropdownValueFW1 as String?,
      dropdownValueFW2: identical(dropdownValueFW2, _sentinel) ? this.dropdownValueFW2 : dropdownValueFW2 as String?,
      dropdownValueFW3: identical(dropdownValueFW3, _sentinel) ? this.dropdownValueFW3 : dropdownValueFW3 as String?,
