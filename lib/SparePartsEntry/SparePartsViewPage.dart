...
class SparePartsViewPage extends StatefulWidget {
  final DateTime? fromDate;
  final DateTime? toDate;

  const SparePartsViewPage({super.key, this.fromDate, this.toDate});

  @override
  State<SparePartsViewPage> createState() => _SparePartsViewPageState();
}

class _SparePartsViewPageState extends State<SparePartsViewPage> {
  DateTime? fromDate;
  DateTime? toDate;
