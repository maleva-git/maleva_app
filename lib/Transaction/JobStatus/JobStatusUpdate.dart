...
part 'package:maleva/Transaction/JobStatus/mobileJobStatusUpdate.dart';


class JobStatusUpdate extends StatefulWidget {

  const JobStatusUpdate({super.key});

  @override
  JobStatusUpdateState createState() => JobStatusUpdateState();
}
//test
class JobStatusUpdateState extends State<JobStatusUpdate> {
  bool progress = false;
