...
tabletdesign(StockTransferUpdateState state, BuildContext context) {
                               ...
                               decoration: InputDecoration(
                                 ...
                                 suffixIcon: InkWell(
                                     child: Icon(
                                         ...
                                         size: 35.0),
                                     onTap: () async {
                                       if(state.txtBarcodeNo.text == "" && state.txtWareHouse.text == ""){
                                         objfun.toastMsg("Enter Job No", "", context);
                                         return;
                                       }
                                       if (state.txtWareHouse.text == "" &&
                                         ...
                                         Navigator.push(
                                           ...
                                           MaterialPageRoute(
                                               builder: (context) =>
                                                 ...
                                                 (dynamic value) async {
                                               state.setState(() {
                                                 state.txtWareHouse.text = objfun
                                                     .SelectAllStatusList
                                                     .StatusName;
