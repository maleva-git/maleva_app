...
tabletdesign(SalesOrderAddState state, BuildContext context) {
                          ...
                          ListView(shrinkWrap: true, children: <Widget>[
                            ...
                            SizedBox(
                              ...
                              child: (state.PickUpAddressList.isNotEmpty
                                  ...
                                  child: const Center(
                                    child: Text('No Record',style: TextStyle(
                                      fontSize: 20
                                    ),),
                                  ))),
                            ),
                                                          ...
                                                          child: Row(
                                                            children: [
                                                              ...
                                                              Expanded(
                                                                ...
                                                                child:
                                                                Text(
                                                                 state.ProductViewList[index].ItemQty.toString(),
                                                                  textAlign:
                                                                  TextAlign.left,
                                                                  style:
                                                                  GoogleFonts.lato(
                                                          ...
                                                          child: Row(
                                                            children: [
                                                              Expanded(
                                                                flex: 3,
                                                                child:
                                                                Text(  "   ${state.ProductViewList[index]
                                                                      .SalesRate}",
                                                                  textAlign:
                                                                  TextAlign.left,
                                                                  style:
                                                              ...
                                                              Expanded(
                                                                ...
                                                                IconButton(
                                                                  ...
                                                                  icon:
                                                                  const Icon(Icons.mode_edit_outline_outlined,size:35),
                                                                  color:
                                                                  colour.commonColor,
