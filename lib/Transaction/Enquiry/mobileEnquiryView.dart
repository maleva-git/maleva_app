part of 'package:maleva/Transaction/Enquiry/EnquiryView.dart';


mobiledesign(EnquiryViewState state, BuildContext context) {
                              ...
                              child: InkWell(
                                ...
                                onLongPress: () {
                                  state.setState(() {
                                    ...
                                    Navigator.push(
                                            context, MaterialPageRoute(builder: (context) => AddEnquiry(SaleMaster:objfun.EnquiryMasterList[index])));
                                  });
                                },
                                child: Card(
