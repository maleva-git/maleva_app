...
import 'package:maleva/Transaction/Enquiry/AddEnquiry.dart';
...
part 'package:maleva/Transaction/Enquiry/mobileEnquiryView.dart';
part 'package:maleva/Transaction/Enquiry/tabletEnquiryView.dart';

class EnquiryView extends StatefulWidget {
  const EnquiryView({super.key});

  @override
  EnquiryViewState createState() => EnquiryViewState();
}

class EnquiryViewState extends State<EnquiryView> {
  bool progress = false;
