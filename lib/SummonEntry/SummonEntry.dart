...
import 'SummonViewPage.dart';


class Summonentry extends StatefulWidget {
  const Summonentry({super.key});

  @override
  State<Summonentry> createState() => _SummonentryState();
}

class _SummonentryState extends State<Summonentry> {
...
// ---------- Summon Dropdown ----------
                      DropdownButtonFormField<String>(
                        ...
                        items: (selectedCountry == "Malaysia"
                            ? malaysiaList
                            : singaporeList)
                        ...
                        onChanged: (value) {
                          setState(() {
                            ...
                            SummonTypeController.text = value; // store into your text field
                          });
                        },
                        validator: (value) {
                          if (value == null || value.isEmpty) {
